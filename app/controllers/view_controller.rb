...
class ViewController < ApplicationController
    def all
        ...
        @multi = Hash.new()
        @multi['TADL-WOOD'] = Array.new()
        @multi['TADL-EBB'] = Array.new()
        @multi['TADL-FLPL'] = Array.new()
        @multi['TADL-KBL'] = Array.new()
        @multi['TADL-IPL'] = Array.new()
        @multi['TADL-PCL'] = Array.new()
        @circ_label = []
        csv.each do |row|
